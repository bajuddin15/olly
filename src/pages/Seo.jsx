...
export default function Seo() {
  ...
  const { keyword, searchIntent } = location.state || {};
    ...
    setMessages([
      {
        ...
        content: `
                ...
                You are a  SEO keyword expert with 20 years of experience. I want you to respond only in the Any language that user will input. I want you to act as a keyword research expert that speaks and writes fluent Any language. First, find the keyword ideas that are related to ${keyword}. Search intent is ${searchIntent}. 
