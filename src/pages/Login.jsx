        ...
        <div className="flex flex-col w-full h-full">
          <div className="flex flex-row justify-center items-center mt-5">
            <h1 className="text-3xl font-medium text-gray-900">
              Login to your AI marketing tool.ai account
            </h1>
          </div>
          <div className="flex flex-col w-full mt-3">
            <div className="flex flex-col mt-5">
              ...
              <input
                ...
                type="email"
                required={true}
                className="w-full h-12 mt-2 px-4 border border-gray-300 rounded-lg focus:outline-none focus:border-brand"
          ...
          <div className="flex flex-col w-full mt-5">
            <button
              onClick={login}
              className="transition-all ease-in w-full h-12 bg-brand text-white rounded-lg font-medium text-lg"
            >
              {loginText}
            </button>
          </div>
          ...
          <div className="flex flex-col w-full mt-5">
            <button
              ...
              className="transition-all ease-in w-full h-12 bg-white text-brand border border-brand rounded-lg font-medium text-lg"
            >
              Login with Google
            </button>
          </div>
