    ...
    React.useEffect(() => {
        ...
        setMessages([

            {
                ...
                Your task is to Use the Problem-Agitate-Solve framework, write an email marketing campaign where the ideal customer ${inputOne} has a problem ${inputTwo} list the problem here ${inputThree}, agitate that problem and solve with ""product, service or idea""  All output shall be in Any language.
            ...
            {showInput ? <div className='flex flex-col w-full'>
                <div className='flex flex-col w-full mt-8 space-y-6 h-full'>
                    <div className='flex flex-col w-full space-y-1'>
                        <label className='text-gray-600 font-medium'>Who is your ideal customer for this email? (i.e.  Smoker)</label>
                    ...
                    <div className='flex flex-col md:flex-row w-full space-y-4 md:space-y-0 md:space-x-5'>
                        ...
                        <div className='flex flex-col w-full space-y-1'>
                            <label className='text-gray-600 font-medium'>Lets solve customers problem with (i.e.  Edibles)</label>
